function [Q, s, tmp] = find_takagi_factor (A) 
...
% get size of matrix
% n = input('Enter the size of the matrix: '); % P!
n=length(A);  % P!
...
% A = csgen(sv); % P!
% nSteps = input('Enter the number of Lanczos iterations: '); %P
nSteps=256; % P! was 500 steps before, must be equal to M
